...
{{-- Flowbite CSS (if needed) - ensure compatibility with Tailwind --}}
{{-- Note: Flowbite 3.1.2 is quite old. Consider updating to Flowbite 2.x which works with Tailwind 3.x --}}
