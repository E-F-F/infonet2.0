<x-hrms::layouts.master>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const eventForm = document.getElementById('eventForm'); // Get the form itself
            ...
            // --- MODIFIED: Save Button shows the modal ---
            saveButton.addEventListener('click', function() {
                // Show the modal instead of submitting the form
                confirmationModal.classList.remove('hidden');
                confirmationModal.classList.add('flex'); // Use flex to enable vertical centering
            });

            // --- NEW: Modal Confirm Button Action ---
            modalConfirmButton.addEventListener('click', function() {
                // When confirmed, submit the form
                eventForm.submit();
            });

            // --- NEW: Modal Cancel Button Action ---
            modalCancelButton.addEventListener('click', function() {
                // When cancelled, just hide the modal
